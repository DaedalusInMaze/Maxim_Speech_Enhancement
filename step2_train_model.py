...
recovered_path = os.path.join(DATADIR, 'recovered_mask_limit6')
model_path = os.path.join(DATADIR, 'models_mask_limit6')
...
valid_dataset = NoisyData(valid_list[:50], SNR, noises, random_seed=True, random_noise=True)
